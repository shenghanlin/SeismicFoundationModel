...
class U_Net(nn.Module):
    ...
    """
    def __init__(self, in_ch=1, out_ch=1,Super=False,Interpolation=False):
    ...
    def forward(self, x):
        ...
        out = self.Conv(d2)
        if self.Interpolation:
            loss = self.forward_Interpolationloss(img, out, mask)
...
if __name__ == '__main__':
    ...
    model = U_Net(in_ch=1, out_ch=1,Super=False,Interpolation=True)
